 ...
 * @LastEditTime: 2022-09-20 14:43:29
...
<script lang="ts">
  ...
  import CardList from './module/CardList.vue';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const domesGeneralInfoDoList = async (obj) => {
        ...
        list.value = res.list;
        secondLevelList.value = res.secondLevelList;
        loadingRef.value = false;
      };
      domesGeneralInfoDoList({ firstLevel: '专家机构', secondLevel: activeKey.value, ...page });
