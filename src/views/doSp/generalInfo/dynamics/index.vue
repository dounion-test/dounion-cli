 ...
 * @LastEditTime: 2022-09-20 14:10:30
    ...
    <a-tabs class="!px-2 dynamics-tabs" v-model:activeKey="activeKey" @change="handleTabsChange">
      <template v-for="item in secondLevelList" :key="item.secondLevel">
        <a-tab-pane :tab="item.secondLevel">
          <TabsList
            @change="handleChange"
            routerName="GeneralInfoDynamicsView"
            :list="list"
            :pageNo="pageNo"
            :pageSize="pageSize"
            :total="total"
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      domesGeneralInfoDoList({ firstLevel: '前沿动态', ...page });
