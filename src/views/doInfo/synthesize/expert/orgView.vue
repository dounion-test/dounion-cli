 ...
 * @LastEditTime: 2022-09-14 16:43:53
...
<template>
  <PageWrapper contentFullHeight>
    <div class="view-con">
      <div class="view-left mr-10">
        <img class="view-img" src="https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png" />
        <div class="ml-5 mb-2">机构名称：中国农业大学</div>
        <div class="ml-5 mb-2">所在国家：中国</div>
        <div class="ml-5 mb-2">所在地区：北京</div>
        <div class="ml-5 mb-2 whitespace-nowrap">机构官网：https://os.alipayobjects.com</div>
      </div>
      <div class="flex-1">
        <div class="mb-4 mt-4">{{ text }}</div>
      </div>
    </div>
  </PageWrapper>
</template>
